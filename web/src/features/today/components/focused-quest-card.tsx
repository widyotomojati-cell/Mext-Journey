...
export function FocusedQuestCard({quest,assignmentId="",status="available",startAction,completeAction}:Props) {
 ...
 return <article className="quest-card" aria-labelledby="quest-title">
  ...
  {started ? <div className="quest-card__form">
    ...
    <div className="mentor-cta"><Button type="submit" variant="outline" className="rounded-xl border-primary/35 bg-secondary text-primary hover:bg-primary hover:text-primary-foreground">Minta review mentor · opsional</Button><small>Mentor menilai arah jawaban, bukan pengalaman personal lo.</small></div>
